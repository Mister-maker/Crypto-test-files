...
## Stress folders (generated by `generate_extra.py` / `generate_correct.py`)

Four additional top-level folders target detection quality specifically:
...
```
python3 generate_extra.py     # quantum-vulnerable/, quantum-resistant/, false-positives/
