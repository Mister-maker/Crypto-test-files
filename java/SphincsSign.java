...
/** SphincsSign -- synthetic crypto naming demo. References SHA1 / Salsa20. */
public class SphincsSign {
    public static final String DEFAULT_CIPHER = "AES-128-CBC";
    public static final String DEFAULT_HASH = "SHA_256";
    private final String[] algorithms = {"SHA1", "Salsa20", "LMS", "Ed25519"};
    ...
    public static void main(String[] args) throws Exception {
        SphincsSign demo = new SphincsSign();
