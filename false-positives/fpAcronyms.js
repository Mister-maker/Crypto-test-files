// JavascriptFpAcronyms -- acronym-expansion decoys and negations; benign.
...
const version_140rc2 = "1.4.0-rc2 (a release candidate, not the RC cipher)";
const version_200RC4 = "2.0.0-RC4 (a release candidate, not the RC cipher)";
const version_310rc6 = "3.1.0-rc6 (a release candidate, not the RC cipher)";
const version_09RC1 = "0.9-RC1 (a release candidate, not the RC cipher)";
